...
class SaleWizard(models.TransientModel):
    ...
    def _default_session(self):
        return self.env['academy.session'].browse(self._contex.get('active_id'))
    ...
    session_student_ids = fields.Many2many(comodel_name='res.partnet',
